/*
Velocity jar contains StringEscapeUtils that are escaping forward slashed. This bad behaviour disturbs our measurement, therefore we need to use another version of StringEscapeUtils that is not doing so.
 */
/*
...
public class StringEscapeUtils {
     ...
     * entity and so is not supported). </p>
     *
     ...
     * the actual Unicode characters corresponding to the escapes.</p>
     *
     * <p>
     * Supports only the five basic XML entities (gt, lt, quot, amp, apos). Does
     * not support DTDs or external entities.</p>
     ...
     * a comma, newline or double quote, <code>null</code> if null string input
     * @since 2.4
     */
    ...
    /**
     * <p>
     * Returns a <code>String</code> value for an unescaped CSV column. </p>
     *
     * <p>
     ...
     * unescaped to just one double quote. </p>
     *
     * <p>
     ...
     * quotes removed and embedded double quotes unescaped, <code>null</code> if
     * null string input
     * @throws IOException if error occurs on underlying Writer
     * @since 2.4
     */
