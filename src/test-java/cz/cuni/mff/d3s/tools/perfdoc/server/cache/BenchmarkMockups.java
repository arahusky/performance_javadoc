...
public class BenchmarkMockups {
    ...
    public static final BenchmarkSettingImpl benSet1 = new BenchmarkSettingImpl(method1, workload1, methodArguments1, measurementQuality1);
    public static final BenchmarkSettingImpl benSet2 = new BenchmarkSettingImpl(method2, workload2, methodArguments2, measurementQuality2);
    public static final BenchmarkSettingImpl benSet3 = new BenchmarkSettingImpl(method3, workload3, methodArguments3, measurementQuality3);
    public static final BenchmarkSettingImpl benSet4 = new BenchmarkSettingImpl(method4, workload4, methodArguments4, measurementQuality4);
