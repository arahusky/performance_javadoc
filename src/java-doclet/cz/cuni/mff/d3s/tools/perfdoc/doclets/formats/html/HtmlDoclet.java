...
import cz.cuni.mff.d3s.tools.perfdoc.doclets.internal.toolkit.builders.*;
...
public class HtmlDoclet extends AbstractDoclet {
    ...
    protected void generateOtherFiles(RootDoc root, ClassTree classtree)
        ...
        if (configuration.stylesheetfile.length() == 0) {
            ...
            Util.copyFile(configuration, "dygraph-combined.js", Util.RESOURCESDIR,
                    (configdestdir.isEmpty()) ?
                        System.getProperty("user.dir") : configdestdir, false, true);
            Util.copyFile(configuration, "jquery-ui.min.css", Util.RESOURCESDIR,
                    (configdestdir.isEmpty()) ?
                        System.getProperty("user.dir") : configdestdir, false, true);
            Util.copyFile(configuration, "jquery-ui.min.js", Util.RESOURCESDIR,
                    (configdestdir.isEmpty()) ?
                        System.getProperty("user.dir") : configdestdir, false, true);
            Util.copyFile(configuration, "jquery-1.11.2.min.js", Util.RESOURCESDIR,
                    (configdestdir.isEmpty()) ?
                        System.getProperty("user.dir") : configdestdir, false, true);
            copyImages();            
        }
    ...
    /**
     * Copy jQuery images to given folder
     */
    private void copyImages() {
        
        String[] images = new String[] {"ui-bg_diagonals-thick_18_b81900_40x40",
            "ui-bg_diagonals-thick_20_666666_40x40",
            ...
            "ui-bg_highlight-soft_75_ffe45c_1x100",
            "ui-bg_highlight-soft_100_eeeeee_1x100",
            "ui-icons_228ef1_256x240",
            "ui-icons_222222_256x240",
            "ui-icons_ef8c08_256x240",
            "ui-icons_ffd27a_256x240",
            "ui-icons_ffffff_256x240"};
                
        for (String image : images) {
            Util.copyResourceFile(configuration, image + ".png", false);
        }
    }
