...
public class TagletManager {
    ...
    private void checkTaglet(Object taglet) {
        ...
        } else if (taglet instanceof cz.cuni.mff.d3s.tools.perfdoc.doclets.Taglet) {
            cz.cuni.mff.d3s.tools.perfdoc.doclets.Taglet legacyTaglet = (cz.cuni.mff.d3s.tools.perfdoc.doclets.Taglet) taglet;
