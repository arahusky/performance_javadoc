...
package cz.cuni.mff.d3s.tools.perfdoc.doclets.internal.toolkit.taglets;

import com.sun.javadoc.*;

/**
 * This taglet acts as a wrapper to enable
 * {@link cz.cuni.mff.d3s.tools.perfdoc.doclets.Taglet} type taglets to work
...
public class LegacyTaglet implements Taglet {
    ...
    private cz.cuni.mff.d3s.tools.perfdoc.doclets.Taglet legacyTaglet;

    public LegacyTaglet(cz.cuni.mff.d3s.tools.perfdoc.doclets.Taglet t) {
        legacyTaglet = t;
    }
