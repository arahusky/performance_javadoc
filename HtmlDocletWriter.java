...
import cz.cuni.javadoc.*;
import cz.cuni.tools.doclets.formats.html.markup.*;
import cz.cuni.tools.doclets.internal.toolkit.*;
import cz.cuni.tools.doclets.internal.toolkit.util.*;
import cz.cuni.tools.doclets.internal.toolkit.taglets.*;
...
public class HtmlDocletWriter extends HtmlDocWriter {
    ...
    protected void addTagsInfo(Doc doc, Content htmltree) {
     ...
     /**
     * Adds the performance information.
     *
    ...
    protected void addPerformanceInfo(MethodDoc doc, Content htmltree) {
        ...
        //if there's any workload annotation contaiting some generator
    ...
    {                
        ...
        for (AnnotationDesc annotDesc : annotations)
        {
            ...
            if ("cz.cuni.annotations.Workload".equals(annotDesc.annotationType().toString()))
            {
                ...
                {                    
                    //just for sure
                    if (e.element().toString().equals("cz.cuni.annotations.Workload.value()"))
                    {                        
     ...
     * <p>
     * For example, suppose cz.cuni.javadoc.RootDoc has this link:
     * &lt;a href="package-summary.html"&gt;The package Page&lt;/a&gt;
     * <p>
     * If this link appeared in the index, we would redirect
     * the link like this:
     *
     * &lt;a href="./cz.cuni.javadoc/package-summary.html"&gt;The package Page&lt;/a&gt;
     *
